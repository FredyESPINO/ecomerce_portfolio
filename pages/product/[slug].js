                    ...
                    <div className="buttons">
                      {
                        ...
                        <button type="button" className="add-to-cart" onClick={handleAddSomething}>Add an item.</button> 
                        :
                        <button type="button" className="add-to-cart" onClick={() => onAdd(product, qty)}>Add to Cart</button>
                      }

                        <button type="button" className="buy-now" onClick={qty===0 ? 
                          handleAddSomething:handleBuyNow}>Buy Now</button>
                    </div>
            </div>
        </div>
